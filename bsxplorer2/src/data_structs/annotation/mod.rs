...
///   attributes.
/// - [`GffEntryAttributes`]: A structured representation of the key-value
///   pairs found in the GFF attributes column.
...
///   [`GffEntry`] instances. It provides efficient ways to query entries
///   by genomic location using an interval tree and by parent-child
///   relationships using a tree structure.
///
